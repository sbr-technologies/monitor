    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Edit Additional Language</span>
                </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Edit Additional Language
            <small>please edit additional language information</small>
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Please edit additional language information</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <?php
                        $attributes = array('class' => 'form-horizontal', 'id' => 'edit-additional-language-form');
                        echo form_open('edit-additional-language/' . $encrypted_id, $attributes);
                        ?>
                        <input type="hidden" name="additional_language_id" id="additional_language_id" value="<?= $result['id'] ?>">
                        <div class="form-body">
                            <?php
