...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Availability Manager List
            <small>all availability manager</small>
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Begin: availability management Listing -->
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">List of all the availability</span>
                        </div>
                        <div class="actions">
                            <a type="button" class="btn btn-primary" href="<?= base_url('add-availability') ?>">Add New Availability</a>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td class="dt-center">
                                            <input type="text" class="form-control form-filter input-sm" name="availability_name">
                                        </td>
                                        <td class="dt-center">
                ...
                <!-- End: availability management Listing -->
