    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Business Feature Attribute</span>
                </li>
            </ul>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Business Feature Attribute Info
            <small>list of business feature attributes related to each feature</small>
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Begin: Business feature attribute Listing -->
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">List of all business feature attributes</span>
                        </div>
                        <div class="actions">
                            <a type="button" class="btn btn-primary" href="<?= base_url('add-business-feature-attribute') ?>">Add Feature Attribute</a>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td class="dt-center">
                                            <select id="feature_id" name="feature_id" class="form-control form-filter input-sm">
                                                <option value="">Select...</option>
                                                <?= $main_feature_info ?>
                                            </select>
                                        </td>
                                        ...
                                        <td class="dt-center dt-button-collection">
                                            <div class="margin-bottom-5">
                                                <button class="btn btn-sm green filter-submit margin-bottom dt-button" id = "search-feature-list">
                ...
                <!-- End: Business feature attribute Listing -->
