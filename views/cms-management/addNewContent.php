...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Add New Content
            <small>please add new content</small>
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <?php
                        $attributes = array('class' => 'form-horizontal', 'id' => 'add-new-content');
                        echo form_open('add-new-content', $attributes);
                        ?>
                        <div class="form-body">
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 input_element">
                                    <textarea class="form-control" name="word_en"><?php echo set_value('word_en') ?></textarea>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-md-4 input_element">
                                    <textarea class="form-control" name="word_iw"><?php echo set_value('word_iw') ?></textarea> 
                                </div>
                            </div>
