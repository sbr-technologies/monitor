...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> Add Expertise Area
            <small>please add expertise area details</small>
        </h1>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Please provide information for expertise area</span>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <?php
                        $attributes = array('class' => 'form-horizontal', 'id' => 'add-expertise-area-form');
                        echo form_open('add-expertise-area', $attributes);
                        ?>
                        <div class="form-body">
                            <?php
